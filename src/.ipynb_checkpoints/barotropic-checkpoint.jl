...
function compute_barotropic_rhs_nonCoriolis!(
    ...
    # ========================================================
    # 6. Viscosity: harmonic on velocities (U, V)
    #    Add dissipative term:  ν H ∇²U and ν H ∇²V
    # ========================================================
    gradx = U_face  # reuse U_face / V_face as gradient buffers
    grady = V_face

    termx .= M ./ H_in_u #reuse termx
